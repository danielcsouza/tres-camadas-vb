<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/modelo.Master" CodeBehind="Login.aspx.vb" Inherits="camadas_VB.Login" %>
 ...
 <fieldset><legend>Acesso ao sistema</legend>
  ...
  <div class="control-group">
   ...
   <div class="form-actions">
     <asp:Button ID="btnEnviar" runat="server" Text="Acessar" CssClass="btn btn-large btn-inverse" OnClick="btnEnviar_Click"/>
</div>
